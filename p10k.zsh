# Generated by Powerlevel10k configuration wizard on 2021-04-16 at 18:21 CEST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND="${ICON_FOREGROUND}"
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION="${ICON_CONTENT_EXPANSION}"
